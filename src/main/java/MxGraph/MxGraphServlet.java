...
public class MxGraphServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
    {
        ...
        String ModelType="";
        if(request.getParameter("Model").equals("Conceptual")){
            ModelType="ConceptualModelTask";
        }
        else if (request.getParameter("Model").equals("Logical")){
            ModelType="LogicalModelTask";
        }
        else if (request.getParameter("Model").equals("Computational")){
            ModelType="ComputationalModelTask";
        }
        ...
        if (request.getParameter("Type").equals("Save")){
            ...
            doc.append("TaskName",request.getParameter("TaskName"));
            doc.append("Description",request.getParameter("Description"));
            doc.append("GraphXML",request.getParameter("GraphXML"));
            if(request.getParameter("Model").equals("Computational")){
                doc.append("LogicalXML",request.getParameter("LogicalXML"));
            }
            doc.append(request.getParameter("Model")+"XML",request.getParameter(request.getParameter("Model")+"XML"));
            doc.append("CID",request.getParameter("CID"));
            doc.append("CreateTime",dateFormat.format(date));
            try{
            ...
            if(request.getParameter("Model").equals("Computational")) {
                newDoc.put("LogicalXML", request.getParameter("LogicalXML"));
            }
